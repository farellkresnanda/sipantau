...

    {
        ...
        children: [
            ...
            },
            {
                ...
                href: '/master/inspeksi-apd',
                icon: HardHat,
            },
            {
                title: 'Master Inspeksi Gedung',
                href: '/master/inspeksi-gedung',
                icon: Building2,
            },
            {
                title: 'Master Inspeksi Genset',
                href: '/master/inspeksi-genset',
                icon: Power,
            },
            {
                title: 'Master Inspeksi K3L',
                href: '/master/inspeksi-k3l',
                icon: Recycle,
            },
            {
                title: 'Master Inspeksi K3L Deskripsi',
                href: '/master/inspeksi-k3l-deskripsi',
                icon: InfoIcon,
            },
            {
                title: 'Master Inspeksi P3K',
                href: '/master/inspeksi-p3k',
                icon: BriefcaseMedical,
            },
            {
