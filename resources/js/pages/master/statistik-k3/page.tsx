...
export default function PageEntitas({ masterStatistikK3 }: { masterStatistikK3: never[] }) {
            ...
            <div className="p-4">
                <div className="mb-3 flex flex-col items-center justify-between gap-4 sm:flex-row">
                    ...
                    <Button asChild className="w-full sm:w-auto">
                        <Link href="/master/statistik-k3/create">Create Data</Link>
                    </Button>
                </div>
                <div className="w-full">
                    <DataTable columns={columns} data={masterStatistikK3} />
                </div>
            </div>
        </AppLayout>
    );
