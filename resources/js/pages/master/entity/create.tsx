...
export default function CreateUser() {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        router.post(route('entity.store'), values, {
            onSuccess: () => {
                form.reset();
            },
        });
            ...
            <div className="space-y-6 p-4">
                <div className="flex items-center justify-between">
                    <SectionHeader
                        ...
                        subtitle="Isi formulir di bawah ini untuk membuat entity baru. Pastikan semua kolom yang wajib diisi telah dilengkapi."
                    />
                </div>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input maxLength={4} placeholder="Enter code entity" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
