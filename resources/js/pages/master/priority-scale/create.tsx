...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Skala Prioritas', href: '/master/priority-scale/create' },
];

// Validasi minimal: hanya wajib isi
const formSchema = z.object({
    name: z.string().min(1, 'Nama wajib diisi').max(255),
    scale: z.string().min(1, 'Skala Prioritas wajib diisi'),
});
...
export default function CreateProbabilitas() {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        router.post(route('priority-scale.store'), values, {
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input type="text" placeholder="Masukkan angka scale" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
