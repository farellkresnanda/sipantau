...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Buat Master Gedung', href: '/master/gedung/create' },
];
...
export default function CreateMasterGedung({ plants }: { plants: Plant[] }) {
    ...
    function onSubmit(values: FormSchemaType) {
        router.post(route('gedung.store'), values, {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-4">
                <SectionHeader
                    ...
                    subtitle="Masukkan data lokasi gedung di entitas terkait."
                />
