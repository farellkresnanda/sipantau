...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: '/master/building-work-standard/create',
    },
];

const formSchema = z.object({
    name: z.string().min(1, 'Nama is required').max(255),
    description: z.string().min(1, 'Keterangan is required').max(255),
...
export default function CreateMasterBuildingWorkStandard() {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        router.post(route('building-work-standard.store'), values, {
            onSuccess: () => {
                form.reset();
            },
        });
            ...
            <div className="space-y-6 p-4">
                <div className="flex items-center justify-between">
                    <SectionHeader
                        ...
                        subtitle="Isi formulir di bawah ini untuk membuat standar kerja building baru. Pastikan semua kolom yang wajib diisi telah dilengkapi."
                    />
                </div>
