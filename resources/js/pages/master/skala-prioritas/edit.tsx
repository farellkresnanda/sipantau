...
const formSchema = z.object({
    ...
    skala: z.string().min(1).max(255),
});

type FormSchemaType = z.infer<typeof formSchema>;

export default function EditSkalaPrioritas({ masterSkalaPrioritas }: { masterSkalaPrioritas: { id: number; nama: string; skala: string } }) {
    ...
    const form = useForm<FormSchemaType>({
        ...
        defaultValues: {
            nama: masterSkalaPrioritas.nama || '',
            skala: masterSkalaPrioritas.skala || '',
        },
    });
    ...
    function onSubmit(values: FormSchemaType) {
        ...
        router.put(route('skala-prioritas.update', masterSkalaPrioritas.id), formData);
    }
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="Enter Angka skala" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
