...
interface VerifyBuildingDialogProps {
    inspection: {
        uuid: string;
...
export default function VerifyBuildingDialog({ inspection }: VerifyBuildingDialogProps) {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        router.post(`/inspection/building/verify/${inspection.uuid}`, finalFormData, {
            preserveScroll: true,
            forceFormData: true,
            onSuccess: () => {
                setOpen(false);
                toast.success('Building Inspection approved successfully.');
            },
            onError: (errors) => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Verifikasi Inspeksi Building</DialogTitle>
                    <DialogDescription>Form ini hanya untuk  memverifikasi hasil inspeksi Building.</DialogDescription>
                </DialogHeader>
