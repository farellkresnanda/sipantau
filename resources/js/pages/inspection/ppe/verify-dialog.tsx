...
export default function ValidatorVerifyPpeDialog({ inspection }: ValidatorVerifyPpeDialogProps) {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        router.post(`/inspection/ppe/verify/${inspection.uuid}`, finalFormData, {
            preserveScroll: true,
            forceFormData: true,
            onSuccess: () => {
                setOpen(false);
                toast.success('PPE inspection berhasil diverifikasi');
            },
            onError: (errors) => {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Form ini hanya untuk Validator memverifikasi hasil inspeksi APD.</DialogDescription>
                </DialogHeader>
